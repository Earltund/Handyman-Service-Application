...
/// Section Widget
Widget _buildNinetyEight(BuildContext context) { return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Padding(padding: EdgeInsets.only(top: 1.v), child: Text("Today", style: CustomTextStyles.titleSmallBlack900_1)), Text("Mark all read", style: CustomTextStyles.titleSmallGray50001)]); } 
